...
- configure your terminal to use the [[https://github.com/morhetz/gruvbox][gruvbox]] theme. There's a `misc/themes` folder within this repo that can help you with that. 
...
- now open you shell and change your git information
#+BEGIN_SRC shell
