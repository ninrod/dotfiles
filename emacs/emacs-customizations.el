 ...
 '(ibuffer-fontification-alist
   (quote
    ((10 buffer-read-only font-lock-constant-face)
     ...
     (1
      (or
       (eq major-mode (quote emacs-lisp-mode))
       (eq major-mode (quote lisp-mode)))
