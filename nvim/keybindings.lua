...
function M.setup_snacks_picker_keybindings(picker)
	...
	vim.keymap.set("n", "s.", function()
		picker.files({ cwd = vim.fn.getcwd(0) })
	end, { desc = "[S]earch current directory [F]iles" })
	...
	vim.keymap.set("n", "sp", picker.projects, { desc = "[S]witch [P]roject" })
	vim.keymap.set("n", "gh", picker.recent, { desc = '[S]earch Recent Files ("." for repeat)' })
